...
\section{Interests}
Reinforcement Learning, LLM Alignment \& Safety,
Online Learning, Optimization, Retrieval-Augmented Generation, Multi-Armed Bandits, Graphical Models, Fair Resource Allocation, CDN Caching
% Online Optimization, Convex Optimization, Resource Allocation, CDN Caching, Reinforcement Learning, Multi-Armed Bandits, Linear Programming, Natural Language Processing, Graphical Models, Game Theory, Information Theory, Machine Learning

\bibliographystyle{unsrt}
\nocite{rlc,joshi2026onlinecachingtree,joshi2026reusableresource,sinha2023no,universal2022}
...
% {\customcvproject{Online Caching in Tree Networks: Algorithms, Regret, and Complexity (Accepted at \href{https://sites.google.com/usc.edu/l4dc2026/}{L4DC 2026})}{}{
% \begin{itemize}
...
% {\customcvproject{Learning to Allocate Reusable Resources under Stochastic Rewards and Durations (Under review at SIGMETRICS)}{}{
%   \begin{itemize}
...
{\customcventry{Jul'21 - Jul'23}{Tata Institute of Fundamental Research \& IIT-Madras}{Research Assistant}{Mumbai, India}{}
  {
    \begin{itemize}
      ...
      \item Developed regret-minimization algorithms for adversarial request sequences and fairness-aware resource allocation problems.
      \item Resulted in publications at \textit{NeurIPS} and \textit{IEEE Information Theory Workshop}.
    \end{itemize}
}}
...
{\customcventry{Jan'19 - May'19}{Chennai Mathematical Institute}{Research Intern (BTech Project)}{Chennai, India}{}
  {
    \begin{itemize}
      ...
      \item The primary approach is to create a Markov Random Field whose partition function is the permanent of a square matrix. Then use Belief Propagation to compute Bethe Free Energy which approximates the permanent. We then try to generalize the algorithm to compute permanent of rectangular matrices. (Link to \href{https://github.com/AtivJoshi/Perm-Approx}{Code} and \href{https://github.com/AtivJoshi/Perm-Approx/blob/master/Approximating_Permanent_CMI.pdf}{Report})
    \end{itemize}
}}
...
{\customcventry{May'18 - Jul'18}{Institute of Mathematical Sciences}{Summer Student}{Chennai, India}{}
  {
    \begin{itemize}
      ...
      \item Attended lectures on topics of theoretical computer science like Parameterized Complexity, Automata Theory, Games and Distributed Algorithms, Computational Geometry, Logic etc. (Link to \href{https://github.com/AtivJoshi/IMSc/blob/master/IMSc_Certi.pdf}{Certificate})
    \end{itemize}
}}
%\vspace{0pt}
{\customcventry{May'17 - July'18}{IIT-Gandhinagar}{Research Intern}{Gandhinagar, India}{}
  {
    \begin{itemize}
      ...
      \item Topics studied include Zippel's work on sparse interpolation, Ben-Or/Tiwari's Deterministic interpolation algorithm, early termination approach by Kaltofen et. al., non monic case of sparse GCD by de Kleine et. al., parallel GCD algorithm by Monagan/Hu etc. Implementation is done in Python using SymPy. (Started as a summer intern and later visited IIT-Gn weekly during the third year of BTech). (Links to \href{https://github.com/AtivJoshi/Zippel/blob/master/IITGn_Certi.pdf}{Certificate}, \href{https://github.com/AtivJoshi/Zippel}{Code} and \href{https://github.com/AtivJoshi/Zippel/blob/master/Polynomial_GCD_IITGn.pdf}{Report})
    \end{itemize}
}}

\section{Research Projects}
\customcvproject{Knowledge-Graph Grounded LLM Evaluation}{}{
\begin{itemize}
  \item Built a retrieval-augmented framework to evaluate LLM reasoning faithfulness by retrieving relevant knowledge-graph subgraphs, converting chain-of-thought reasoning into structured triples, and verifying them against the graph. (Link to \href{https://github.com/ayushagupta/kg-faith-eval-framework}{Code})
\end{itemize}
}

\customcvproject{Adaptive Retrieval for Retrieval-Augmented Generation}{}{
\begin{itemize}
  \item Designed a contextual bandit framework to dynamically combine sparse (BM25) and dense neural retrieval for query-dependent ranking, improving retrieval performance on benchmarks such as MS MARCO and BEIR. (Link to \href{https://github.com/AtivJoshi/ir-project}{Code})
\end{itemize}
}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Teaching Experience}
\textbf{University of Massachusetts, Amherst}: CS 689 (Machine Learning), CS 683 (Artificial Intelligence), 
CS 515 (Algorithms \& Game Theory), CS 250 (Introduction to Computation)

\textbf{Ahmedabad University}: CSC210 (Data Structures and Algorithms).
...
Machine Learning, Reinforcement Learning, Advanced NLP, 
Advanced Information Retrieval, Randomized Algorithms, 
Game Theory,
% Algorithmic Game Theory, Information and Coding Theory, Algorithms and Optimisation for Big Data, Wireless Communications, Computer Networks, Digital Signal Processing, Reinforcement Learning, Computational Complexity, Game Theory, Stochastic Processes, Linear Programming \& Combinatorial Optimization, Graph Theory, Machine Learning, Randomized Algorithms, Advanced Natural Language Processing, Advanced Information Retrieval, Advance Information Assurance
% \begin{multicols}{3}
%   \textbf{BTech}
%   \begin{itemize}
...
\begin{minipage}{\maincolumnwidth}%
  \small{
    \begin{itemize}
      ...
      \item Currently helping to organize \href{https://solar.cs.umass.edu/ai-era/}{Research in the AI Era}.
